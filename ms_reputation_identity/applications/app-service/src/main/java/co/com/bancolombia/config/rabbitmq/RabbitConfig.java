...
public class RabbitConfig {
    ...
    LoggerAdapter adapter = new LoggerAdapter(SYSTEM_VTN, SERVICE_PROFILE, "CONNECTION");
    ...
    @Bean
    @Profile({"dev", "qa", "pdn"})
    public SecretModelRabbit getCredentialRabbit(
            SecretsManagerConsumer<SecretModelRabbit> consumer) throws SecretException {
