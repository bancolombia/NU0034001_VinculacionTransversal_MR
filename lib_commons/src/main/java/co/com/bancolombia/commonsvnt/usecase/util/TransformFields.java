...
public class TransformFields {
    ...
    public String transform(String str, String format){
        ...
        if (format!=null){
            switch (format){
                case NUMBER_SN:
                    str = CAT_S.equals(str)? Numbers.ONE.getNumber():Numbers.TWO.getNumber(); break;
                case ZETA_SN:
                    str = CAT_Z.concat(str); break;
                case MARK_CORR:
                    str = CAT_EMPTY.equals(str)?Numbers.ZERO.getNumber():Numbers.ONE.getNumber(); break;
                case LAST_TWO:
                    str = str.substring(Numbers.FOUR.getIntNumber()); break;
                default:
                    break;
            }
        }
    ...
    public String modDNN(Date date){
        return (date==null)?null:coreFunctionDate.toFormatDate(date);
    }

    public String modInt(Object data){
