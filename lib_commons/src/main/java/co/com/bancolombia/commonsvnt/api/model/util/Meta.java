...
public class Meta {
    ...
    @Pattern(regexp = ConstantsRegex.REGEX_UUID,
            message = "_messageId tiene que corresponder a la expresión regular '${regexp}'")
    @ApiModelProperty(example = "3a15584b-6a7a-4ba2-8d27-3fea93c97b8a")
    @Size(min = 36, max = 36)
    @NotNull
