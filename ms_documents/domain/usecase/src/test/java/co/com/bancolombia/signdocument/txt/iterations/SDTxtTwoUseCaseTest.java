...
public class SDTxtTwoUseCaseTest {
    ...
    public void createIteration() throws IOException {
        ...
        PersonalInfoReply personalInfoReply = PersonalInfoReply.builder()
                .firstName("a").secondName("a").firstSurname("a").secondSurname("a")
                .createdDate(now).expeditionDate(now).birthdate(now).build();
        ...
        sdTxtTwoUseCase.createIteration(bw, SDRequestTxt.builder().build(), personalInfoReply);
        verify(sdTxtTwoUseCase, times(1)).createIteration(bw, SDRequestTxt.builder().build(), personalInfoReply);
    }
}
