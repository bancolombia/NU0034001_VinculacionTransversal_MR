...
@EnableJpaRepositories(
        ...
        basePackages = {"co.com.bancolombia.jpa"})
public class JpaConfig {
    ...
    public DataSource primaryDataSource(
            @Qualifier("primaryDataSourceProperties")
                    DataSourceProperties primaryDataSourceProperties, SecretsManagerConsumer<SecretsModel> consumer,
            @Qualifier("secretConfig") SecretConfig secrectConfig) {
